class SQL_CONST {
    ...
    static SQL_SET_LICENCA = 'UPDATE LAMMER_LIC SET DATA_ATIVACAO = ?, DIAS_RESET = ?, DATA_VENCIMENTO = ?, DATA_PAGAMENTO = ?, ULTIMO_SERIAL = ? WHERE 1 = 1';
    ...
    // Produto Aliquota
    static SQL_PRODUTO_ALIQUOTA_INSERT = "INSERT INTO PRODUTO_ALIQUOTA (IDPRODUTO, UF, CST, CFOP, ALIQUOTA, REDUCAO_BASE, ALIQUOTA_FECOEP) VALUES (?, ?, ?, ?, ? , ?, ?);";
